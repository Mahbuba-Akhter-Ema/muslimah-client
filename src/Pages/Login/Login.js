			...
			<div className="hero-content flex-col lg:flex-row-reverse">
				...
				<div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-600 text-gray-100">
					...
					<div className="flex items-center pt-4 space-x-1">
						...
						<p className="px-3 text-sm text-gray-400">Login with social account</p>
						<div className="flex-1 h-px sm:w-16 bg-gray-700"></div>
					</div>
					<div className="flex justify-center space-x-4">
						<button aria-label="Login with Google" type="button" className="flex items-center justify-center w-9/12 p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-400 focus:ring-violet-700">
